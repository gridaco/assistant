import { reflectColorToFigmaRGB, reflectColorToFigmaRGBA } from "@bridged.xyz/design-sdk/lib/figma/converters/color.convert"
...
export function renderCgRect(rectManifest: FigmaRenderRectManifest): RectangleNode {
